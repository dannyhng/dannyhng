...
# Danny (Thu) Hoang
### Network Operations & Infrastructure | CCNA & Security+ Certified
...
**Network Engineer transitioning to NetDevOps.** <br/>
...
### About Me
I am a Network Engineer transitioning from traditional infrastructure management to **NetDevOps**. While I have a strong foundation in routing and switching (Cisco CLI), my focus is on **Infrastructure as Code (IaC)**.  
I don't just study networking concepts; I build, break, and automate them in a production-grade hybrid environment. My goal is to bridge the gap between hardware operations and software-defined automation.

### Current Focus
* **Infrastructure:** Architecting hybrid environments using Proxmox VE and Bare Metal Linux.
* **Automation:** Replacing manual "ClickOps" with **Ansible** playbooks and **Python** scripts.
* **Security:** Implementing Zero Trust architecture using **Tailscale** and **pfSense**.
...
#### 1. [Enterprise Hybrid Home Server Infrastructure](https://github.com/dannyhng/hybrid-homelab-infrastructure)
...
| :--- | :--- |
| **Network Automation** | Ansible, Python (Netmiko), Git, YAML, JSON |
| **Infrastructure** | Proxmox VE, Docker, Portainer, TrueNAS Scale, Linux (Ubuntu/RHEL) |
| **Networking** | TCP/IP, OSPF, VLANs, DNS (AdGuard), VPN (Tailscale/WireGuard), pfSense |
| **Observability** | Prometheus, Grafana, Wireshark, Syslog |
| **Security** | Firewalls, ACLs, Zero Trust Principles, IAM (Authentik), SSL/TLS (Nginx Proxy Manager) |
